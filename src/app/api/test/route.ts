...
export async function HEAD(request: NextRequest) {
  ...
  return new NextResponse(null, {
    status: 200,
    headers: methodTemplates.responseHeaders.HEAD,
  });
}
...
export async function OPTIONS(request: NextRequest) {
  ...
  return new NextResponse(null, {
    status: 200,
    headers: methodTemplates.responseHeaders.OPTIONS,
  });
}
...
export async function TRACE(request: NextRequest) {
  ...
  return NextResponse.json({
    status: 200,
    headers: methodTemplates.responseHeaders.TRACE,
    body: { message: "TRACE request successful" },
  });
}
...
export async function CONNECT(request: NextRequest) {
  ...
  return NextResponse.json({
    status: 200,
    headers: methodTemplates.responseHeaders.CONNECT,
    body: { message: "CONNECT request successful" },
  });
}
